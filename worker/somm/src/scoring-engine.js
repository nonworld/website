...
const PRODUCTS = [
  {
    ...
    facts: {
      ...
      popularity: 'the best seller: the most ordered bottle of the six over the last 12 months',
    },
  ...
  },
  {
    ...
    facts: {
      ...
      storage: 'Cool, dry place. Sparkling stopper preserves the carbonation. Refrigerate after opening, drink within 5-7 days.',
      popularity: 'sixth most ordered of the six over the last 12 months',
    },
  ...
  },
  {
    ...
    facts: {
      ...
      popularity: 'second most ordered of the six over the last 12 months',
    },
  ...
  },
  {
    ...
    facts: {
      ...
      caffeine: 'none',
      storage: 'Cool, dry place. Sparkling stopper preserves the carbonation. Refrigerate after opening, drink within 5-7 days.',
      popularity: 'third most ordered of the six over the last 12 months',
    },
  ...
  },
  {
    ...
    facts: {
      ...
      storage: 'Cool, dry place. Sparkling stopper preserves the carbonation. Refrigerate after opening, drink within 5-7 days.',
      popularity: 'fifth most ordered of the six over the last 12 months',
    },
  ...
  },
  {
    ...
    facts: {
      ...
      caffeine: 'none',
      storage: 'Cool, dry place. Sparkling stopper preserves the carbonation. Refrigerate after opening, drink within 5-7 days.',
      popularity: 'fourth most ordered of the six over the last 12 months',
    },
